...
class MinecraftBot extends koishi_1.Bot {
    ...
    async createDirectChannel(userId) {
        return { id: `private:${userId}`, type: 1 };
    }
...
// ============================================================================
class MinecraftMessageEncoder extends koishi_1.MessageEncoder {
    buffer = '';
    async flush() {
        if (!this.buffer)
            return;
        ...
        this.buffer = '';
        const adapter = this.bot.adapter;
...
MinecraftBot.MessageEncoder = MinecraftMessageEncoder;
// ============================================================================
// Koishi Schema 配置
// ============================================================================
